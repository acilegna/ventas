                                ...
                                @if (session('productos') !== null)
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-danger" type="submit" name="accion"
                                            value="cancelar"><i class="fa fa-cube"></i>Cancelar Venta</button>
                                    </div>
                                @endif
        ...
        <div class="contenido">
            <div class="form-inline">
                <div class="btn-group group-left">
                    <a href="javascript:void(0)" class="btn btn-primary mb-2" id="busquedas"><i
                            class="fa fa-search"></i>Buscar</a>
                </div>


                <div class="btn-group group-left">
                    <a href="#" class="btn btn-primary mb-2" id="verificadorb"><i
                            class="fa fa-binoculars"></i>Verificador</a>
                </div>
                ...
                <table class="table table-striped table-bordered" name="tabla1" id="tabl">
                    ...
                    <tbody id="venta">
                        ...
                        @foreach (session('productos') as $producto)
                            ...
                            @foreach ($sql_mayoreo as $productos_mayoreo)
                                @if ($id_agregado == $productos_mayoreo->id_prod)
                                    @php
                            ...
                            @if ($id_prod == $id_agregado and $total[1] != 1)
                                ...
                                @endphp
                            @endif
                            {{-- Fin codigo para productos que no se registro mayoreo --}}
                                ...
                                <td>
                                    <form action="{{ route('addDelete') }}" method="post">
                                        ...
                                        <a data-toggle="tooltip" data-placement="bottom" title="Aumente la cantidad">
                                            <button class="btn btn-outline-danger" type="submit" name="elimina"
                                                value="elimina"><i class="fa fa fa-minus-square"></i> </button>
                                        </a>
                                        {{ $producto->cantidad }}
                                        <a data-toggle="tooltip" data-placement="bottom" title="Aumente la cantidad">
                                            <button class="btn btn-outline-danger" type="submit" name="accion"
                                                value="agrega"><i class="fa fa fa-plus-square"></i> </button>
                                        </a>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form action="{{ route('buscarProducto') }}" method="post" id="verificaForm" name="productForm"
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" value="1" id="agregarVarios"
                                name="agregarVarios">Agregar a Venta</button>

                            <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                id="closeVerificador">Cancelar</button>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="input-group text-center">
                                                ...
                                                <h1 id="total_pagar" class="text-center"
                                                    style="font-size:50px;color:#0d069c"></h1>
                                ...
                                <div class="col-4">
                                    <button class="btn btn-outline-success" type="submit" name="accion"
                                        value="terminar">Terminar Venta</button>
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
